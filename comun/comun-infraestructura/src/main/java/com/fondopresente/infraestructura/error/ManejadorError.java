package com.fondopresente.infraestructura.error;


import java.util.concurrent.ConcurrentHashMap;

import com.fondopresente.dominio.excepcion.ExcepcionAutenticacion;
...
import com.fondopresente.dominio.excepcion.ExcepcionDuplicidad;
import com.fondopresente.dominio.excepcion.ExcepcionLongitudValor;
import com.fondopresente.dominio.excepcion.ExcepcionSinDatos;
import com.fondopresente.dominio.excepcion.ExcepcionValorInvalido;
import com.fondopresente.dominio.excepcion.ExcepcionValorObligatorio;
...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(ExcepcionAutorizacion.class.getSimpleName(), HttpStatus.FORBIDDEN.value());
